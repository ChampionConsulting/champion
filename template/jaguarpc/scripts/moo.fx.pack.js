...
by Valerio Proietti (../http/MS_2.html) MIT-style LICENSE
for more info visit (../http/MS_1.html).
...
Remember.prototype = {
	...
	setCookie: function(value) {
		...
		document.cookie = this.el+this.el.id+this.prefix+"="+value+expires+"; path=../index.html";
	},
