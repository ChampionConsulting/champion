...
/**
 * display all the blog tags in a blog location
 * 
 * @param array $tag_runner_context Extra content to provide to tags
 */
function tag_blog_tags (array $tag_runner_context = []) {
	
	$tag = new \championcore\tags\BlogTags();
	
	$result = $tag->generate_html(
		['location' => $GLOBALS['tag_var1'] ],
		$tag_runner_context,
...
# call
echo tag_blog_tags( (isset($tag_runner_context) ? $tag_runner_context : array()) );
