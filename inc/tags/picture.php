...
# call
echo \championcore\tags\Picture::execute_tag(
	array(
		'src'            => $GLOBALS['tag_var1'],
		'alt'            => $GLOBALS['tag_var2'],
		
		'element_width'  => (isset($GLOBALS['tag_var3']) ? $GLOBALS['tag_var3'] : null),
		'element_height' => (isset($GLOBALS['tag_var4']) ? $GLOBALS['tag_var4'] : null)
	),
