 ...
 * navigation block
 */
echo \championcore\tags\Navigation::execute_tag(
	[
		'label'          => (empty($GLOBALS['tag_var1']) ? 'all' : $GLOBALS['tag_var1']),
		'css_classes'    => (empty($GLOBALS['tag_var2']) ? ''    : $GLOBALS['tag_var2']),
		'css_classes_ul' => (empty($GLOBALS['tag_var3']) ? ''    : $GLOBALS['tag_var3']),
		'css_classes_li' => (empty($GLOBALS['tag_var4']) ? ''    : $GLOBALS['tag_var4']),
		'css_classes_a'  => (empty($GLOBALS['tag_var5']) ? ''    : $GLOBALS['tag_var5'])
