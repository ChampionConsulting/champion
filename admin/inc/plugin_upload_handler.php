...
/**
 * plugin zip file upload handler
 */
function page_plugin_upload_handler() {
	
	$page_handler = new \championcore\page\admin\PluginUploadHandler();
...
# call
echo page_plugin_upload_handler();
