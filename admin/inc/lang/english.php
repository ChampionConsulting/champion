...
// Auto backup
$lang_autobackup_email_subject_line = 'Champion auto-backup reminder';
$lang_autobackup_email_text =<<<EOD
Hi,

Your Champion install has generated a backup zip file.

Regards,
The Champion CMS Team
EOD;
...
$lang_login_forgot_password_email_body =<<<EOD
	...
	Your Champion password is PASSWORD
EOD;
$lang_login_forgot_password_email_subject_line = "Forgot your Champion password?"; 
...
$lang_blog_featured_image = 'Blog Featured Image';
...
// Settings
$lang_settings_title = 'Champion Settings';
...
$lang_champion_serial = 'Champion Serial #';
...
$lang_settings_title_made_in_champion = 'Made in Champion';
$lang_settings_made_in_champion       = 'Made in Champion badge added';
$lang_settings_made_in_champion_label = 'Enable made-in-champion content for template';
...
$lang_ai_image_header = 'OpenAI / Stable Diffusion image generation';
...
$lang_settings_blog_blog_flag_show_link = 'Show link to blog content';
$lang_settings_blog_blog_flag_show_teaser_image = 'Show the teaser image';
...
$lang_export_html_header                   = 'Exporting to HTML in folder';
$lang_export_html_text                     = '(You can change your export folder path in Account > Settings.) <br /><br /> Export Complete';
//// Settings: RSS
...
$lang_settings_upload_general_error = 'An error has occurred when uploading';
...
$lang_settings_navigation_non_champion_page            = 'Add non Champion item';
$lang_settings_navigation_non_champion_name            = 'Name';
$lang_settings_navigation_non_champion_open_in_new_tab = 'Open in new tab';
$lang_settings_navigation_non_champion_url             = 'URL (* include http or https for non Champion URLs)';
...
$lang_settings_template_string_admin_login_welcome_tooltip = 'Anything in a span tag is highlighted. Current: Hi! Champion User';
...
// Unishop
$lang_settings_unishop_title = 'Champion Commerce';
...
// Admin - Update
$lang_update_title     = 'Update a Champion CMS install';
$lang_update_title_sub = 'Upload the new ChampionCMS zip file';

$lang_update_button        = 'Update';
$lang_update_button_cancel = 'Cancel';

$lang_update_title_pick_method = 'How would you like to upload your Champion CMS file ?';
$lang_update_type_upload       = '(Recommended) Upload the file from my computer';
$lang_update_type_ftp          = 'I uploaded the new file to this webserver. (Ex. I used FTP). I will specify a path.';

$lang_update_title_from_ftp = 'Specify a path on this server';
$lang_update_path_to_zip    = 'Path to zip';

$lang_update_error_file = 'File is not present';

$lang_update_done_title    = 'Update complete';
$lang_update_done_download = 'Download update log';

$lang_update_prepare_title         = 'Preparing Update';
$lang_update_prepare_msg_cancelled = 'Update cancelled';
$lang_update_prepare_progress      = '%d files analyzed (%2.1f%%))';
$lang_update_prepare_text          = 'Analyzing files ... (comparing file checksums)';

$lang_update_results_title            = 'Update Results';
$lang_update_results_button_all       = 'Update All (Recommended)';
$lang_update_results_button_selected  = 'Selected';
$lang_update_results_download_current = 'Download Current';
$lang_update_results_download_new     = 'Download New';
$lang_update_results_changed_files    = '%d Changed Files';
$lang_update_results_select_all       = 'Select All';
$lang_update_results_select_none      = 'Select None';

$lang_update_updating_title    = 'Updating files ...';
$lang_update_updating_progress = '%d of %d files updated (%3.1f%%))';

# Plugin & Tags Page
$lang_plugins_tags = (object)[
	'menu' => 'Plugins Cheatsheet',
	'page' => (object)[
		'title' => 'Installed plugins and tags and how to use them',
