...
/**
 * DISABLE prior to removal - now replaced by a route in the dispacher
 *
 ...
 * /
function page_media_upload_handler() {
	
	$page_handler = new \championcore\page\admin\MediaUploadHandler();
...
# call
echo page_media_upload_handler();
*/
