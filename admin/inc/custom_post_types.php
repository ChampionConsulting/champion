...
/**
 * custom post type page handler
 */
function page_custom_post_type_handler() {
	
	$page_handler = new \championcore\page\admin\CustomPostType();
...
# call
echo page_custom_post_type_handler();
