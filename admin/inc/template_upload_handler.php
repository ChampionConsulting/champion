...
/**
 * template zip file upload handler
 */
function page_template_upload_handler() {
	
	$page_handler = new \championcore\page\admin\TemplateUploadHandler();
...
# call
echo page_template_upload_handler();
