...
/**
 * display a slide of images from a media gallery
 */
class Slide extends Base {
	...
	public static function execute_tag (array $tag_vars, array $tag_runner_context = [], string $tag_content = '') : string {
		...
		$tag = new \championcore\tags\Slide();
	...
	public function generate_html (array $params = [], array $tag_runner_context = [], string $tag_content = '') : string {
		...
		\championcore\get_context()->theme->css->add(     CHAMPION_BASE_URL . "/championcore/asset/vendor/flexslider/flexslider.css");
		\championcore\get_context()->theme->js_body->add( CHAMPION_BASE_URL . "/championcore/asset/vendor/flexslider/jquery.flexslider-min.js", [], 'flexslider' );
		
		\championcore\get_context()->theme->js_body->add( CHAMPION_BASE_URL . "/championcore/asset/js/tag/slide.js", ['baguetteBox', 'flexslider'] );
		
		# render template
		$view = new \championcore\View( \championcore\get_configs()->dir_template . '/tags/slide.phtml' );
